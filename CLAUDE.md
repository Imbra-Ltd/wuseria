...
- `docs/optical-specs/` — verified per-lens optical reference data, one subfolder per lens (ADR-031, ADR-033): `analysis.md` (MTF readings, predictions), `scoring-log.md` (per-lens scoring justification), `notes.md` (mandatory technical specs provenance log), construction diagrams and MTF charts as PNG or SVG
