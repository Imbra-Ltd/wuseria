# Meike 85mm f/2.8 Macro — Specs Log
...
- Same optical design across all mounts — Z-mount page used for spec extraction
- Product title mentions "aspherical" but no count is given; not adding asphericalElements without confirmed count
