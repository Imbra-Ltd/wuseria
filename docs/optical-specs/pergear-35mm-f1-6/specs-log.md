...
- **opticalElements:** 6 (official, Shopify, allphotolenses)
- **opticalGroups:** 4 (official, Shopify, allphotolenses)
- **specialElements:** none found in any source
- **coating:** HD MC / multi-coated (full name: "Pergear 35mm f/1.6 HD.MC"; official describes "Multi-MC Layer Coating")
- **maxMagnification:** not published — checked 12+ sources, none list it
- **constructionDiagram:** not found anywhere
- **MTF chart:** not found anywhere

## Physical spec discrepancies found

- **weight:** DB has 185g, Shopify + allphotolenses say 193g
- **minFocusDistance:** DB has 250mm, Shopify + allphotolenses say 280mm (28cm)
