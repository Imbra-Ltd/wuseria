...
- **Construction diagram:** found — saved as `construction-diagram.jpg` (from DPReview forum thread, sourced from syzygx.com official ZY Optics page). Shows 11 elements in 7 groups, double Gauss + focal reducer design.
