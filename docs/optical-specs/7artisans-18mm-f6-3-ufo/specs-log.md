...
- The DB entry "18mm f/6.3 UFO" maps to the MF 18mm f/6.3 Mark II pancake.
- Source conflict on groups: official Mark II page states 6 elements / 5 groups;
  LensTip (id 1760) lists 6 elements / 4 groups — likely the Mark I. Used the
  official Mark II figure (5 groups) since the DB entry is the Mark II.
- maxMagnification 0.2x is taken from LensTip; no magnification on the official page.
