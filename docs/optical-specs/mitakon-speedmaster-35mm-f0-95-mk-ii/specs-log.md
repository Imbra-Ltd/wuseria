...
- **Discrepancy:** LensTip Mk II spec page (ID 1406) lists "2 EHR elements, 3 HR elements" = 5 HRI total, vs zyoptics.net "2 Extra-High RI + 1 High RI" = 3 HRI. Official manufacturer page (zyoptics.net) used as authoritative source. LensTip may have sourced from a different spec revision or made a data entry error.
