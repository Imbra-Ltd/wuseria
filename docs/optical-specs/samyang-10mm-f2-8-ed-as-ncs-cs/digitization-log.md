...
# Digitization log: samyang-10mm-f2-8-ed-as-ncs-cs
...
- **Chart:** `docs/optical-specs/samyang-10mm-f2-8-ed-as-ncs-cs/samyang-10mm-f2-8-ed-as-ncs-cs-mtf.png`
...
```
  ...
  EX   freq30S        █████████▇▆  (0.98 → 0.75)
  EX   freq30M        █▇▇▇▇▇▆▆▆▆▅  (0.98 → 0.54)
```
...
| -------------- | ------------ | ---------- | ------------ |
| freq10S        |         0.99 |       0.98 |         0.96 |
| freq10M        |         0.99 |       0.93 |         0.89 |
| freq30S        |         0.98 |       0.86 |         0.75 |
| freq30M        |         0.98 |       0.65 |         0.54 |
...
| ----- | ----- | -------- | ------ |
| `not_suspiciously_flat` | `freq10S` | — | mean 0.983 >= 0.95 and stdev 0.009 <= 0.01 (11/11 defined) — idealized/placeholder? |
...
| freq30S        | 11/11    |  2/11       |  3/11             |
| freq30M        | 11/11    |  0/11       |  0/11             |

```
  EX   freq10S        ███████████  (0.99 → 0.99)
  EX   freq10M        ██████████▇  (0.99 → 0.90)
  EX   freq30S        ███████████  (0.99 → 0.98)
  EX   freq30M        ████▇▇▇▆▆▆▅  (0.99 → 0.58)
```
...
| freq30S        |         0.99 |       0.98 |         0.98 |
| freq30M        |         0.99 |       0.65 |         0.58 |
...
| `not_suspiciously_flat` | `freq30S` | — | mean 0.987 >= 0.95 and stdev 0.004 <= 0.01 (11/11 defined) — idealized/placeholder? |
