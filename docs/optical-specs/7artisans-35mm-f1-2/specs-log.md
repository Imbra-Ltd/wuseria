...
| ------------------- | ---------------------------------- | ---------- | -------------------------------------------------------------------------------------- |
| Official (Shopify)  | 7artisans.store/products/35mm-f1-2 | 2026-05-27 | Found: 6 elements / 5 groups (Sonnar formula)                                          |
...
- **opticalElements:** 6 (official)
- **opticalGroups:** 5 (official; "Sonnar formula with numerous refinements")
- **specialElements:** none stated
- **coating:** none stated
- **maxMagnification:** not found (not estimated per project rule)
