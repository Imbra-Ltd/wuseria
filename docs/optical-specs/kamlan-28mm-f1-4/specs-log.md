# Kamlan 28mm f/1.4 — Specs Log

## Sources checked

| Source               | URL                                                                                     | Date       | Result                                                                                        |
| -------------------- | --------------------------------------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------- |
| Official Kamlan page | kamlan.com.tw/page/product/show.aspx?num=59&lang=TW                                     | 2026-05-23 | Found: 7 groups 8 elements ("7組8片")                                                         |
| Dustin Abbott        | dustinabbott.net                                                                        | 2026-05-23 | Found: 8 elements / 7 groups (via Bing snippet)                                               |
| Adorama listing      | adorama.com                                                                             | 2026-05-23 | Found: 6 HR elements                                                                          |
| CeX listing          | cex.com                                                                                 | 2026-05-23 | Found: 6 HR elements                                                                          |
| lens-db.com          | lens-db.com                                                                             | 2026-05-23 | Found: 6 HR elements (says 8/6, but official says 8/7 — trust official)                       |
...
- **opticalElements:** 8 (official page, confirmed by construction diagram)
- **opticalGroups:** 7 (official page, confirmed by construction diagram)
- **specialElements:** 6 HR (Adorama, CeX, lens-db, Photography Life "6 HRI elements", construction diagram)
- **coating:** multi-coating (Alik Griffin review, no proprietary name)
- **maxMagnification:** 0.15x (Photography Life spec table)
- **afMotor:** manual focus only (official page: "對焦方式：手動")
