# Meyer Optik Trioplan 100mm f/2.8 II — Specs Log

## Sources checked

| Source                    | URL                                                     | Date       | Result                                                                   |
| ------------------------- | ------------------------------------------------------- | ---------- | ------------------------------------------------------------------------ |
| Official Meyer Optik page | meyer-optik-goerlitz.com/en/lenses/trioplan-100-f2.8-ii | 2026-05-24 | Found: 3 elements, classic triplet design, "newly designed lens coating" |
...
- **weight:** 800g → 320g (official: "320g - 390g", using low end for X-mount; DB had wildly wrong value)
- **length:** 120mm → 83mm (official: "83mm - 115mm", using low end for X-mount)
