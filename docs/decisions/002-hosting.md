...
| Cloudflare Pages | GitHub Pages already provides HTTPS, CDN (Fastly-backed), and edge caching — Cloudflare adds DDoS protection and WAF, neither needed for a static site with no backend |
