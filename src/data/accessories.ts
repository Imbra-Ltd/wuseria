...
const batteryGrips: BatteryGripAccessory[] = [
  ...
  },
  {
    ...
    brand: "Fujifilm",
    model: "VG-XT1",
    description: "Weather-sealed vertical grip for X-T1. Doubles battery life with 2x NP-W126. Adds portrait controls and command dials.",
    mount: "X",
    compatibleWith: ["X-T1"],
    batteryType: "NP-W126",
    batteryCount: 2,
...
const lensAccessories: LensAccessory[] = [
  ...
  },
  {
    ...
    isWeatherSealed: true,
    price: 500,
    officialUrl: "https://fujifilm-x.com/global/products/accessories/mcex-45g-wr/",
  },
  {
    category: "lens-accessory",
    brand: "Fujifilm",
