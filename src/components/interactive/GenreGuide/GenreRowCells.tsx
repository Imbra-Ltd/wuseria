  ...
  if (genre === "architecture")
    return (
      <>
        ...
        <td>
          <span
            className={el.lens.isWeatherSealed ? styles.dotOn : styles.dotOff}
          />
        </td>
      </>
    );
  if (genre === "portrait")
    return (
      <>
        ...
        <td>{fmtIso(el.idealIso)}</td>
        <td>
          <span className={el.lens.hasOis ? styles.dotOn : styles.dotOff} />
        </td>
      </>
    );
  if (genre === "street")
  ...
  if (genre === "macro")
    return (
      <>
        ...
        <td>
          {el.lens.maxMagnification ? `${el.lens.maxMagnification}x` : "\u2013"}
        </td>
        <td>{fmtIso(el.idealIso)}</td>
        <td>
          <span
